...
export const changelogEntries: ChangelogEntry[] = [
  ...
  {
    slug: "phase-43",
    title: "Syndication + Burundi / CAR / Equatorial Guinea desks",
    phase: "43",
    status: "draft",
    lede: "Public RSS, sitemap and status doors with no audience figures; Burundi, CAR and Equatorial Guinea graph desks.",
    hrefs: ["/syndication", "/graph/burundi", "/graph/central-african-republic", "/graph/equatorial-guinea"],
  },
  {
    slug: "phase-44",
    title: "Notices + DR Congo / São Tomé / South Sudan desks",
    phase: "44",
    status: "draft",
    lede: "House notice slots with nothing posted; DR Congo, São Tomé and Príncipe, and South Sudan graph desks.",
    hrefs: ["/notices", "/graph/dr-congo", "/graph/sao-tome-and-principe", "/graph/south-sudan"],
  },
  {
    slug: "phase-45",
    title: "Languages + Sudan / Eritrea / Somalia desks",
    phase: "45",
    status: "draft",
    lede: "English is the only live edition; Sudan, Eritrea and Somalia graph desks.",
    hrefs: ["/languages", "/graph/sudan", "/graph/eritrea", "/graph/somalia"],
  },
  {
    slug: "phase-46",
    title: "Units + Cabo Verde / Guinea-Bissau / Comoros desks",
    phase: "46",
    status: "draft",
    lede: "Unit vocabulary with no stored series; Cabo Verde, Guinea-Bissau and Comoros graph desks.",
    hrefs: ["/units", "/graph/cabo-verde", "/graph/guinea-bissau", "/graph/comoros"],
  },
  {
    slug: "phase-47",
    title: "Correspondents + Eswatini / Lesotho desks",
    phase: "47",
    status: "draft",
    lede: "Correspondent seats with no invented bylines; Eswatini and Lesotho graph desks.",
    hrefs: ["/correspondents", "/graph/eswatini", "/graph/lesotho"],
  },
  {
    slug: "phase-48",
    title: "Citations + Seychelles desk",
    phase: "48",
    status: "draft",
    lede: "Citation shapes with no sample print; Seychelles graph desk. Country desks now cover the full set.",
    hrefs: ["/citations", "/graph/seychelles"],
  },
  {
    slug: "phase-17",
